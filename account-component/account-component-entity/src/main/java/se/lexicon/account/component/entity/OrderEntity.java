...
/*
    ...
    private void setPlaceOrder(String placeOrder) {
        this.placeOrder = placeOrder;
    }

    See AccountComponentEntityUnitTest, witch will give an error. This resolves
    in project Lean_AccountDevelop17July.
*/
